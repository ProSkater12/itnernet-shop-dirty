...
public class AdapterHorizontalGridView extends ArrayAdapter<GridViewItem> {
    Context mContext;
    int resourceId;
    ArrayList<GridViewItem> data = new ArrayList<GridViewItem>();

    public AdapterHorizontalGridView(Context context, int layoutResourceId, ArrayList<GridViewItem> data) {
